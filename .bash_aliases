alias ll='eza -al --group --color=always --group-directories-first --icons --git'
alias lll='eza -al --group --color=always --group-directories-first --icons --git --extended'
...
alias l='eza -l --group --color=always --group-directories-first --icons --git'
